...
digest: 2026-08-05T18:05:40 | sweep | batch=1 quarantined=0 applied=0 queued=7 anomalies=0 | verdict=review-warranted

## Snapshot
- 0021_remediate-and-game-v1.2_2026-08-05.md (td_v2)

## Routing and outcomes
== 0021_remediate-and-game-v1.2_2026-08-05.md ==
  valid against td_v2
...
- trigger: unconsidered proposals over threshold (8, oldest 0d)
...
```json
{
  ...
  "deadman_last_age_seconds": 1687.282396554947,
  "handoff": {
    "ask": null,
    "items": [
      "16420efdfb43",
    ...
    "listed": [
      ...
      "7e5f6f22b457 (product-zone)",
      "c87be31d365e (product-zone)",
      "db7c19040554 (product-zone)"
    ],
    "recorded": "2026-08-05T18:05:40",
    "trigger": [
      "unconsidered proposals over threshold (8, oldest 0d)"
    ]
  },
  "human_breaches": [],
  "last_review": "2026-08-05T16:10:14",
  ...
  "trailer_audit_baseline": "58027087f76f2d4f2fd1fd7878495239373d03a9",
  "trigger_history": [
    [
      "16420efdfb43",
      "1d41864b4141",
...
### suggestions.md
```
<!-- generated: sweep.py | 2026-08-05T18:05:40 | corpus: 18cbc6fb | oldest: 2026-08-05 | self: 9b2930dc - do not hand-edit -->
...
- 37c7ab70822c | 2026-08-05 | A `lab/cli/grade-replay.js` that grades any replay file against any named agent would be worth | source: 0021_remediate-and-game-v1.2_2026-08-05.md
...
- 88ac005c1217 | 2026-08-05 | The two candidate findings drafted in `runs/2026-08-05_leak-free-ladder/SUMMARY.md` are worth an | source: 0021_remediate-and-game-v1.2_2026-08-05.md
- baec358c7f95 | 2026-08-05 | `buildManifest` should record WHICH paths were dirty rather than a bare `workingTreeDirty` | source: 0021_remediate-and-game-v1.2_2026-08-05.md
...
- e010125e5e29 | 2026-08-05 | Consider a standing convention that any browser-side mirror of a lab agent must be named in the | source: 0021_remediate-and-game-v1.2_2026-08-05.md
...
### gap-queue.md
```
<!-- generated: sweep.py | 2026-08-05T18:05:40 | corpus: 18cbc6fb | oldest: 2026-08-05 | oldest-listed: 2026-08-05 | self: 0908731c - do not hand-edit -->
...
### promotions.md
```
<!-- generated: sweep.py | 2026-08-05T18:05:40 | corpus: 18cbc6fb | oldest: none | self: 1d1b472f - do not hand-edit -->
