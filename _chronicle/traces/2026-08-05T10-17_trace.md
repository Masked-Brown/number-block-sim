...
digest: 2026-08-05T10:17:19 | sweep | batch=1 quarantined=0 applied=0 queued=2 anomalies=1 | verdict=review-warranted

## Snapshot
- 0003_validate-icm-seeding_2026-08-05.md (td_v2)

## Routing and outcomes
== 0003_validate-icm-seeding_2026-08-05.md ==
  valid against td_v2
  handoff outstanding and younger than T: already-marked, not re-recorded

## Anomalies
- untrailed-record-commit: b3ad656ebdab touches _chronicle/ with no 'Commit-Safe: yes' trailer; the record was written outside commit-safe (canon-changed's sibling)
...
- trigger: gap-queue counted non-empty (1 review-closable; 1 listed, not counted)
...
```json
{
  ...
  "deadman_last_age_seconds": 1597.8783495426178,
  "handoff": {
    "ask": null,
    "items": [
  ...
  "trailer_audit_baseline": "b3ad656ebdab40b626e905d51486e8881a72d74b",
  "trigger_history": [
    [
      "74a1adb95347"
    ],
    [
      "613fdc78e8a2",
      "anomaly:a59d7b41d3f1"
    ]
  ],
  "written": "2026-08-05T10:17:20"
}
```
...
### gap-queue.md
```
<!-- generated: sweep.py | 2026-08-05T10:17:19 | corpus: 9aaaaa84 | oldest: 2026-08-05 | oldest-listed: 2026-08-05 | self: b941540f - do not hand-edit -->
...
### promotions.md
```
<!-- generated: sweep.py | 2026-08-05T10:17:19 | corpus: 9aaaaa84 | oldest: none | self: 1d1b472f - do not hand-edit -->
