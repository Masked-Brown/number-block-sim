...
digest: 2026-08-05T12:41:54 | sweep | batch=1 quarantined=1 applied=0 queued=5 anomalies=1 | verdict=review-warranted

## Snapshot
- 0013_train-lab-and-baselines_2026-08-05.md -> quarantine (invalid: frontmatter field job='NNNN' fails pattern ^\d{4}$)

## Routing and outcomes
== 0013_train-lab-and-baselines_2026-08-05.md ==
  quarantine (vs td_v2): frontmatter field job='NNNN' fails pattern ^\d{4}$

## Anomalies
- quarantined: 0013_train-lab-and-baselines_2026-08-05.md (invalid vs td_v2)
...
- human-facing breach: quarantine non-empty (1 files incl. reason files)
...
```json
{
  ...
  "deadman_last_age_seconds": 261.6334035396576,
  "handoff": {
    "ask": null,
    "items": [
  ...
  "human_breaches": [
    "quarantine non-empty (1 files incl. reason files)"
  ],
  ...
  "trailer_audit_baseline": "7dc9453b0ad43d3b616272a8648fb5c6a2d639b4",
  "trigger_history": [
    [
...
### suggestions.md
```
<!-- generated: sweep.py | 2026-08-05T12:41:54 | corpus: a745e5cc | oldest: 2026-08-05 | self: 88e32ea9 - do not hand-edit -->
...
### map-queue.md
```
<!-- generated: sweep.py | 2026-08-05T12:41:54 | corpus: a745e5cc | oldest: none | self: 4b255a0e - do not hand-edit -->
...
### gap-queue.md
```
<!-- generated: sweep.py | 2026-08-05T12:41:54 | corpus: a745e5cc | oldest: 2026-08-05 | oldest-listed: 2026-08-05 | self: 4bd836ae - do not hand-edit -->
